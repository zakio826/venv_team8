# Generated by Django 4.2.6 on 2023-12-04 08:29
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('asset_name', models.CharField(max_length=12, verbose_name='管理名')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('group_name', models.CharField(max_length=15, null=True, verbose_name='グループ名')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('asset', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='toolkeeper_app.asset', verbose_name='管理項目')),
                ('group', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='toolkeeper_app.group', verbose_name='グループ')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('item_name', models.CharField(max_length=16, verbose_name='アイテム名')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('history', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='toolkeeper_app.history', verbose_name='履歴')),
                ('item', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='toolkeeper_app.item', verbose_name='アイテム')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='history',
            name='image',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='toolkeeper_app.image', verbose_name='写真'),
        ),
        migrations.AddField(
            model_name='history',
            name='user',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('group', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='toolkeeper_app.group', verbose_name='グループ')),
        ...
        migrations.AddField(
            model_name='asset',
            name='group',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='toolkeeper_app.group', verbose_name='グループ'),
        ),
        migrations.AddField(
            model_name='asset',
            name='user',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='管理登録ユーザー'),
        ),
    ]
