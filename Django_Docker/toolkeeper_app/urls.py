...
urlpatterns = [
    ...
    path('asset/<int:asset_id>/delete/', views.AssetDeleteView.as_view(), name='asset_delete'),
    ...
    path('group-detail/<int:group_id>/delete-confirmation/', views.group_delete, name='group_delete'),
    path('group-detail/<int:group_id>/group-host/', views.group_host, name='group_host'),
    path('group-detail/<int:group_id>/leave/', views.group_leave, name='group_leave'),

    path('history/', views.HistoryListView.as_view(), name='history_list'),
    path('history/danger/', views.HistoryListdangerView.as_view(), name='history_list2'),
