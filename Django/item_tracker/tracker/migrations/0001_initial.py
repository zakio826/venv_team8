    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to=settings.AUTH_USER_MODEL, verbose_name='ホストユーザ')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('member', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to=settings.AUTH_USER_MODEL, verbose_name='メンバー')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('asset', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='tracker.asset', verbose_name='管理項目')),
                ('group', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='tracker.group', verbose_name='グループ')),
                ('member', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='tracker.groupmember', verbose_name='メンバー')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to=settings.AUTH_USER_MODEL, verbose_name='撮影ユーザ')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='history',
            name='member',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='tracker.groupmember', verbose_name='メンバー'),
        ),
        migrations.AddField(
            model_name='history',
            name='user',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to=settings.AUTH_USER_MODEL, verbose_name='確認ユーザ'),
        ),
        migrations.AddField(
            model_name='asset',
            name='group',
